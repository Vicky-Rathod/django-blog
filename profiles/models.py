...
def ProfileAvatarUploadPathGenerate(instance, filename):
    ...
    profile_avatar_name = 'user_{0}/'.format(instance.user.id)
...
class Profile(models.Model):
    ...
    image = CloudinaryField('avatar.jpg',folder = ProfileAvatarUploadPathGenerate ,transformation=[{"quality":"auto:best",},{'height': 250, 'width': 250}])
